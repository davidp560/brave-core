...
TEST_F(BraveStatsUpdaterTest, IsDailyUpdateNeededLastCheckedYesterday) {
  ...
  brave_stats::BraveStatsUpdaterParams brave_stats_updater_params(
      GetLocalState(), GetProfilePrefs(), false, kToday, kThisWeek, kThisMonth);
...
TEST_F(BraveStatsUpdaterTest, IsUncertainFutureDisabled) {
  brave_stats::BraveStatsUpdaterParams brave_stats_updater_params(
      GetLocalState(), GetProfilePrefs(), false, kToday, kThisWeek, kThisMonth);
  ASSERT_EQ(brave_stats_updater_params.GetUncertainFutureParam(), "false");
}

TEST_F(BraveStatsUpdaterTest, IsUncertainFutureEnabled) {
  brave_stats::BraveStatsUpdaterParams brave_stats_updater_params(
      GetLocalState(), GetProfilePrefs(), true, kToday, kThisWeek, kThisMonth);
  ASSERT_EQ(brave_stats_updater_params.GetUncertainFutureParam(), "true");
}
...
TEST_F(BraveStatsUpdaterTest, IsWeeklyUpdateNeededOnMondayLastCheckedOnSunday) {
...

  {
    ...
    SetCurrentTimeForTest(current_time);
    brave_stats::BraveStatsUpdaterParams brave_stats_updater_params(
        GetLocalState(), GetProfilePrefs(), false);

...
VerifiableConversionEnvelopeInfo EncryptAndEncodeVerifiableConversion(
  ...
  std::string advertiser_pk_base64 = verifiable_conversion.public_key;
...
// TODO(Moritz Haller): Left it here because otherwise
// - also move base64 helper to unittest
// - include tweetnacl in unittest
